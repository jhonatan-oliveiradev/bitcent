			...
			<div className={`flex flex-col justify-center items-center`}>
				...
				<div className="flex justify-center xl:justify-between items-center justify-items-center gap-7 w-full flex-wrap">
					...
					<Depoimento
						...
						texto="Há tempos tenho tentado organizar meus gastos sem sucesso, até conhecer a BitCENT. Simplesmente mudou minha vida financeira!"
						destaque
					/>
					<Depoimento
						...
						texto="Já consegui organizar todos os meus gastos e, hoje, tenho uma reserva emergencial para 6 meses e estou sempre conseguindo poupar cada vez mais."
					/>
				</div>
			</div>
		</Area>
